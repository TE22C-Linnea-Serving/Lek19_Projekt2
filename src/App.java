            ...
            switch (svar) {
                case 1:
                    ...
                    if (!tangentbord.hasNextInt()) {
                        ...
                        if (((int) (20240000 - subpersonnummer) / 10000) == alder[valPlats]
                                || (((int) (20240000 - subpersonnummer) / 10000) + 1) == alder[valPlats]) {
                ...
                case 3:
                    ...
                    System.out.println("Det finns " + antalLedigt + " lediga platser\n" + under18
                            + " av kunderna är under 18 år, " + over18 + " är över 18 år.\n");

                    for (int i = 0; i < alder.length; i++) {
                        System.out.println(
                                "Namn: " + fornamnPerson[i] + " " + efternamnPerson[i] + "     Ålder: " + alder[i]
                                        + "       Personnummer: " + personnummerPerson[i] + "     Plats: " + (i + 1));
                    }
                    laddar();
